  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ProductHero
        ...
        badge={{ label: t.prodottiPubblico.badgeLabels.confort, color: "green" }}
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <motion.div initial="hidden" animate={advantagesInView ? "visible" : "hidden"} variants={stagger}>
            <motion.div variants={fadeUp} className="text-center mb-10 sm:mb-14">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[hsl(0,0%,10%)]">{t.products.vantaggiFinestra}</h2>
              <p className="text-[hsl(0,0%,45%)] mt-3 max-w-2xl mx-auto text-sm sm:text-base">
                {lang === "ro"
                  ? "Fiecare detaliu al DMR CONFORT este proiectat pentru a garanta funcționalitate, securitate și confort superior."
